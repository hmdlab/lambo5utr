...
from lambo5utr.utils_mutations import mutation_list
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if max_seq_len is None:
            max_seq_len = max([
                len(tokenizer.encode_lambo(cand.mutant_residue_seq)) - 2 for cand in candidate_pool
            ]) + tokenizer.kmer - 1

        self.max_seq_len = max_seq_len
        self.max_len = max_seq_len - tokenizer.kmer + 1
        ...
        if len(candidate_pool) == 0:
            ...
            xu = np.array([
                ...
                2 * self.max_len,  # seq position choice
        ...
        self.max_len = self.max_len + 2 # adding [CLS] and [SEP]
