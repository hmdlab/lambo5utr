...
from lambo5utr.models.masked_layers import mResidualBlock

class LamboBaseLM(nn.Module):
    def __init__(self, device="cpu", device_id=0, **kwargs):
...
class LanguageModel(LamboBaseLM):    
    def __init__(
            self,
            model,
            batch_size,
